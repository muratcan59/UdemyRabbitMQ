...
namespace FileCreateWorkerService.Models
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-5LHOHK1\\MURAT;Initial Catalog=AdventureWorks2019;User ID=sa;Password=sa123;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
